...
const TableOfContents = ({ content }: { content: string }) => {
  ...
  useEffect(() => {
    ...
    const headingsArray = Array.from(doc.querySelectorAll("h2, h3, h4")).map(
      (heading, index) => ({
        id: `heading-${index}`,
        ...
        >
          ...
          <div className={styles.authorSection}>
            <div className={styles.authorInfo}>
              ...
              <div>
                <div className={styles.authorName}>
                  {currentPost.authorName || "Tác giả Võ đường"}
                </div>
            ...
            <div className={styles.headerActions}>
              {currentPost.content && (
                <ReadingTime content={currentPost.content} />
              )}
              <button
          ...
          >
            {currentPost.content ? (
              ...
              <div className={styles.noContent}>
                ...
                <p>
                  Vui lòng quay lại sau để xem nội dung chi tiết của bài viết
                  này.
                </p>
              </div>
            )}
          ...
          <aside className={styles.sidebar}>
            ...
            >
              ...
              <p className={styles.newsletterDescription}>
                Đăng ký để nhận bài viết mới nhất từ Võ đường
              </p>
              <form
